...
<h2 class="main-title-w3layouts mb-2 text-center text-white"
	style="padding-top: 20px">Registration Form</h2>
<!--// main-heading -->
<div
	...
	<form action="/userRegistration" method="post">
		...
		<div class="form-group">
			<label>User Name</label> <input type="text" name="username"
				class="form-control" placeholder="Insert Username" required="">
		</div>

		<div class="form-group">
			<label>Password</label> <input type="password" name="password"
				class="form-control" placeholder="Insert Password" required="">
		</div>

		
		<button type="submit" class="btn btn-primary  mt-sm-5  px-4">Register</button>
	</form>
